...
class CreditTabView extends StatefulWidget {
  @override
  _CreditTabViewState createState() => _CreditTabViewState();
}

class _CreditTabViewState extends State<CreditTabView> {
  Methods methods = Methods();
  List<MessageModel> messages = [];
  @override
  void initState() {
    super.initState();
    methods.getMessageData(2).then((List<MessageModel> res) {
      setState(() {
        messages = res;
      });
    });
  ...
  Widget build(BuildContext context) {
    return new RefreshIndicator(
      onRefresh: () async {
        List<MessageModel> res = await methods.getMessageData(2);
        setState(() {
          messages = res;
        });
      },
